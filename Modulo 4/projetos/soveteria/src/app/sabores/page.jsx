            ...
            <section className={estilos.secaoSabores}>
                ...
                <div className={estilos.sabores}>
                    <div className={estilos.cardSabores}>
                        <Image className={estilos.imgSabor} src={sabor1} alt="Imagem sabor oreo"/>
                        <h3>Sorvete de Oreo</h3>
                        <p>Delicioso sorvete sabor Oreo. Uma explosão de sabor.</p>
                    </div>

                    <div className={estilos.cardSabores}>
                        <Image className={estilos.imgSabor} src={sabor2} alt="Imagem sabor pistache"/>
                        <h3>Sorvete Pistache</h3>
                        <p>Cremoso sorvete sabor pistache com pedacinhos de semente.</p>
                    </div>

                    <div className={estilos.cardSabores}>
                        <Image className={estilos.imgSabor} src={sabor3} alt="Imagem sabor cookies e avelã"/>
                        <h3>Sorvete Cookies & Avelã</h3>
                        <p>O nosso melhor sorvete. Você vai adorar o sabor.</p>
                    </div>

                    <div className={estilos.cardSabores}>
                        <Image className={estilos.imgSabor} src={sabor4} alt="Imagem sabor kiwi"/>
                        <h3>Sorvete de Kiwi</h3>
                        <p>Delicioso e refrescante sorvete sabor kiwi. Rico em vitamina C.</p>
                    </div>

                    <div className={estilos.cardSabores}>
                        <Image className={estilos.imgSabor} src={sabor5} alt="Imagem sabor morango"/>
                        <h3>Sorvete de Morango</h3>
                        <p>Sorvete de morango gourmet. Tradicional e saboroso.</p>
                    </div>

                    <div className={estilos.cardSabores}>
                        <Image className={estilos.imgSabor} src={sabor6} alt="Imagem sabor limão"/>
